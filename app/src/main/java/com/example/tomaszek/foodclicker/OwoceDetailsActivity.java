...
public class OwoceDetailsActivity extends AppCompatActivity {
    int woda_value = 0;
    int owoce_value = 0;
    int inne_value = 0;
    int warzywa_value = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_owoce_details);
        ...
        btnPiramida.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent myIntent = new Intent(OwoceDetailsActivity.this, PiramidActivity.class);
                ...
                OwoceDetailsActivity.this.startActivity(myIntent);
            }
        });
        ...
        btnTabela.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(OwoceDetailsActivity.this, TabelaActivity.class);
                myIntent.putExtra("woda", woda_value); //Optional parameters
                myIntent.putExtra("inne", inne_value); //Optional parameters
                myIntent.putExtra("warzywa", warzywa_value); //Optional parameters
                myIntent.putExtra("owoce", owoce_value); //Optional parameters
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_home:
                        Intent myIntent = new Intent(OwoceDetailsActivity.this, NabialDetailsActivity.class);
                        myIntent.putExtra("woda", woda_value); //Optional parameters
                        myIntent.putExtra("inne", inne_value); //Optional parameters
                        myIntent.putExtra("warzywa", warzywa_value); //Optional parameters
                        myIntent.putExtra("owoce", owoce_value); //Optional parameters
                    ...
                    case R.id.action_info:
                        Intent myIntent2 = new Intent(OwoceDetailsActivity.this, TabelaActivity.class);
                        ...
                        OwoceDetailsActivity.this.startActivity(myIntent2);
                        break;
                    case R.id.action_piramid:
                        Intent myIntent3 = new Intent(OwoceDetailsActivity.this, PiramidActivity.class);
                        ...
                        OwoceDetailsActivity.this.startActivity(myIntent3);
                        break;
                }
                return true;
            }
