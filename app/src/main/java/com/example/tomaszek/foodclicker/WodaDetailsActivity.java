            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_home:
                        Intent myIntent = new Intent(WodaDetailsActivity.this, NabialDetailsActivity.class);
                        myIntent.putExtra("woda", woda_value); //Optional parameters
                        myIntent.putExtra("inne", inne_value); //Optional parameters
                        myIntent.putExtra("warzywa", warzywa_value); //Optional parameters
                        myIntent.putExtra("owoce", owoce_value); //Optional parameters
                    ...
                    case R.id.action_info:
                        Intent myIntent2 = new Intent(WodaDetailsActivity.this, TabelaActivity.class);
                        ...
                        WodaDetailsActivity.this.startActivity(myIntent2);
                        break;
                    case R.id.action_piramid:
                        Intent myIntent3 = new Intent(WodaDetailsActivity.this, PiramidActivity.class);
                        ...
                        WodaDetailsActivity.this.startActivity(myIntent3);
                        break;
                }
                return true;
            }
